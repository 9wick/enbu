 ...
 * - fixtureファイルが存在（src/__tests__/fixtures/simple.enbu.yaml）
 */
...
// currentFileDir = apps/vscode-extension/src/__tests__
// monorepoRoot = apps/vscode-extension/src/__tests__/../../../.. = モノレポルート
